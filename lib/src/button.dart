...
String textButton = "Pajaro fantasma"; // Texto inicial del botón
...
class _MyButtonState extends State<MyButton> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Tarea5_180610"), // Título de la barra de navegación
      ),
      body: Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            ElevatedButton(
              ...
              child: Text("Siguiente Pajaro"), // Texto del botón
            ),
          ],
        ),
      ),
